...
namespace cxon { namespace cio { // type traits
    template <typename K, typename V, typename ...R> struct is_map<boost::container::map<K, V, R...>>       : std::true_type {};
    template <typename K, typename V, typename ...R> struct is_map<boost::container::multimap<K, V, R...>>  : std::true_type {};
}}
