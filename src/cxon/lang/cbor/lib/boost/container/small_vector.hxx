...
#ifndef CXON_CBOR_LIB_BOOST_CONTAINER_SMALL_VECTOR_HXX_
#define CXON_CBOR_LIB_BOOST_CONTAINER_SMALL_VECTOR_HXX_
...
namespace cxon {
    ...
    template <typename X, typename T, std::size_t N, typename ...R>
        struct read<CBOR<X>, boost::container::small_vector<T, N, R...>> {
    ...
    template <typename X, typename T, std::size_t N, typename ...R>
        struct write<CBOR<X>, boost::container::small_vector<T, N, R...>> {
...
#endif // CXON_CBOR_LIB_BOOST_CONTAINER_SMALL_VECTOR_HXX_
