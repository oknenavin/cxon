...
#ifndef CXON_CBOR_LIB_BOOST_CONTAINER_DEQUE_HXX_
#define CXON_CBOR_LIB_BOOST_CONTAINER_DEQUE_HXX_
...
namespace cxon {
    ...
    template <typename X, typename T, typename ...R>
        struct read<CBOR<X>, boost::container::deque<T, R...>> {
    ...
    template <typename X, typename T, typename ...R>
        struct write<CBOR<X>, boost::container::deque<T, R...>> {
...
#endif // CXON_CBOR_LIB_BOOST_CONTAINER_DEQUE_HXX_
