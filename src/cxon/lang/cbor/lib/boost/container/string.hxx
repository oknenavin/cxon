...
#ifndef CXON_CBOR_LIB_BOOST_CONTAINER_STRING_HXX_
#define CXON_CBOR_LIB_BOOST_CONTAINER_STRING_HXX_
...
namespace cxon {
    ...
    template <typename X, typename T, typename ...R>
        struct read<CBOR<X>, boost::container::basic_string<T, R...>> {
    ...
    template <typename X, typename T, typename ...R>
        struct write<CBOR<X>, boost::container::basic_string<T, R...>> {
...
#endif // CXON_CBOR_LIB_BOOST_CONTAINER_STRING_HXX_
