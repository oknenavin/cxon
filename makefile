...
cxon-lang-json-lib-boost-container = \
    ...
    $(srcdir)/lang/json/lib/boost/container/flat_map.hxx \
    $(srcdir)/lang/json/lib/boost/container/flat_set.hxx
...
cxon-lang-cbor-lib-boost-container = \
    ...
    $(srcdir)/lang/cbor/lib/boost/container/flat_map.hxx \
    $(srcdir)/lang/cbor/lib/boost/container/flat_set.hxx
...
cxon-lib-boost-container = \
    ...
    $(srcdir)/lib/boost/container/flat_map.hxx \
    $(srcdir)/lib/boost/container/flat_set.hxx
...
install-cxon:
	...
	@install -p -m 0644 $(cxon-lib-boost)                       $(insdir)/cxon/lib/boost
...
install-lang: install-cxon install-common
	...
	@install -p -m 0644 $(cxon-lang-json-lib-boost)             $(insdir)/cxon/lang/json/lib/boost
	...
	@install -p -m 0644 $(cxon-lang-cbor-lib-boost)             $(insdir)/cxon/lang/cbor/lib/boost
